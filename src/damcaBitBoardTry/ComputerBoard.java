...
public class ComputerBoard extends LogicalBoard {
    ...
    public ComputerBoard(long row0T7, long row8T15, long row16T23, long row24T31, Turn turn, int countBlack, int countWhite, Move lastMove) {
        super();
        this.row0T7 = row0T7;
        this.row8T15 = row8T15;
        this.row16T23 = row16T23;
        this.row24T31 = row24T31;
        this.pcTurn = turn;
...
//		System.out.println(move);
    ...
    public ComputerBoard getNewComputerBoard(Point move, int i, int j) {
        ...
        return new ComputerBoard(this.row0T7, this.row8T15, this.row16T23, this.row24T31, getOtherTurn(), this.countBlack, this.countWhite,
